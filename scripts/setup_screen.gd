...
@onready var btn_next_track: Label = $CracktroUI/BtnNextTrack
...
func _ready():
	...
	if btn_next_track:
		btn_next_track.gui_input.connect(_on_next_track_gui_input)
...
func _on_next_track_gui_input(event: InputEvent):
