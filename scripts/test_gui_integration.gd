...
func _init():
	...
	GameState.start_game("virus", "normal", "OmaVirus")
	...
	print("    Day 15 World Stats: %d infected across %d countries" % [GameState.world_infected, GameState.get_infected_country_count()])
